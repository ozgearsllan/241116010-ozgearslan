    ...
    public partial class FrmYonetmenKayit : Form
    {
        ...
        private void btnkayitet_Click(object sender, EventArgs e)
        {
            ...
            if ( txtad.Text !="" && txtsoyad.Text!= "" && txtbygrfi.Text!= "" && resimYolu!= "")
            {
                ...
                baglanti.Open();
                SqlCommand kayit = new SqlCommand("insert into tb_Yonetmenler (AD_SOYAD,CINSIYET,YAS,BIYOGRAFI,RESIM) VALUES(@p1,@p2,@p3,@p4,@p5) ", baglanti);
        ...
        void yasHesaplama()
        {
          ...
          //  if (yas < 0)
          //  {
          //      MessageBox.Show("Lütfen Tarih Bilgilerini Kontrol ediniz");
          //  }
          //  else if (yas < 18)
          //  {
           //     MessageBox.Show("Yaşınız Reşit Değildir");
